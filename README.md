...
The project enables users to search for players needed for their teams based on different evaluations of input attributes 

The project produces similar player recommendations based on user entries.
